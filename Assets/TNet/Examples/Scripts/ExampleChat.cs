...
public class ExampleChat : TNBehaviour
{
    ...
    void OnJoinChannel(int channelID, bool success, string error)
    {
        ...
        {
            Debug.Log(players.buffer[i].name);
    ...
    void OnGUI()
    {
        GUILayout.TextField(TNet.TNManager.player.name);
        ...
        if (UnityEngine.Application.isPlaying) GUI.SetNextControlName("Name");
        ...
        if (UnityEngine.Application.isPlaying) GUI.SetNextControlName("Chat Window");
        ...
        if (Event.current.type == EventType.KeyUp)
        {
            ...
            if (ctrl == "Name")
            {
                if (keyCode == KeyCode.Return)
                {
                    ...
                    TNManager.playerName = mName;
                    if (UnityEngine.Application.isPlaying) GUI.FocusControl("Chat Window");
                }
            }
            ...
            else if (keyCode == KeyCode.Return)
            {
                ...
                if (UnityEngine.Application.isPlaying) GUI.FocusControl("Chat Input");
            }
    ...
    {
        if (UnityEngine.Application.isPlaying) GUI.SetNextControlName("Chat Input");
