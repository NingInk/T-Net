...
namespace TNet
{
	...
	public class TNManager : MonoBehaviour
	{
		...
		static bool isPlaying { get { return !mDestroyed && UnityEngine.Application.isPlaying; } }
		...
		static TNManager instance
		{
			...
			{
#if UNITY_EDITOR
				if (!UnityEngine.Application.isPlaying) return mInstance;
#endif
				if (mInstance == null)
				{
		...
		{
			if (!mShuttingDown && !mDestroyed && UnityEngine.Application.isPlaying)
